...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/users/fri/stefan_catkin_ws/src/FRI_ARTracker/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/users/fri/stefan_catkin_ws/src/FRI_ARTracker/install/lib;/home/users/fri/catkin_ws/devel/lib;/home/users/harel/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
